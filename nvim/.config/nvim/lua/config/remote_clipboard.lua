-- Vendored verbatim from omarchy-nvim (/usr/share/omarchy-nvim/config/lua/
-- config/remote_clipboard.lua) so it can be re-diffed against upstream. Called
-- from config/options.lua before lazy.nvim starts.
--
